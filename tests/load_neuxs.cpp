...
int main() {
  ...
  try {
    assert(reader.buildDatasetPath(
               250.0f, neuxs::CrossSectionDataType::Elastic,
               neuxs::getMTNumber(neuxs::CrossSectionDataType::Elastic)) ==
    ...
    assert(reader.buildDatasetPath(500.0f, neuxs::CrossSectionDataType::Energy,
                                   0) == "/energy/500K");
    assert(reader.buildDatasetPath(700.0f, neuxs::CrossSectionDataType::Elastic,
